...
export const LandingMiddle = () => {
  return (
    <main className="w-full h-full 2xl:flex sm:pt-[100px] 2xl:pb-[200px]">
      ...
      <section className="min-h-[55vh] sm:min-h-[70vh] 2xl:w-1/3 flex flex-col 2xl:justify-center text-lg">
        <div className="z-[30]">
          <p className="text-black px-10 sm:pt-10 pb-5">
